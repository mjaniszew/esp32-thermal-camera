...
Simple ESP32 thermal camera project. Uses ESP32 with Wifi and `GY-MLX90640` or similar thermal camera working on `I2C` and based on`MLX90640`. After minor modifications it should support Serial (UART) communication since `Adafruit MLX90640` driver supports it.
